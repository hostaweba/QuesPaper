...
class SpeechToTextApp:
    ...
    def create_widgets(self):
        ...
        remove_last_button = tk.Button(toolbar, text="↓ Numbering", command=self.remove_number) #for question
        ...
        self.decrease_button = tk.Button(toolbar, text="↓ Numbering", command=self.decrease_numbering) #for mcqs
    ...
    #for mcqs
    def decrease_numbering(self):
        self.counter4opt -= 1
        if self.counter4opt < 0:
            self.counter4opt = len(self.MCQ_numbers) - 1
