...
class SpeechToTextApp:
    ...
    def create_widgets(self):
        ...
        self.recording_button.configure(background='#f0c478')          
        ...
        remove_last_button.configure(background='#f0c478')  
        ...
        self.recording_button2.configure(background='#7894f0')         
        ...
        self.decrease_button.configure(background='#7894f0')  
        ...
        self.recording_button3.configure(background='#f078c0')          
        ...
        self.rem_sen_button.configure(background='#f078c0')        
        ...
        self.recording_button4.configure(background='#78c4f0')          
        ...
        self.rem_list_button.configure(background='#78c4f0')             
        ...
        blank_line_button.configure(background='#8f8c8e')   
        ...
        copy_button.configure(background='#8f8c8e')   
