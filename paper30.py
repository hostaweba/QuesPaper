...
class SpeechToTextApp:
    ...
    def _recording_thread4(self):
        ...
        try:
            ...
            numbered_text = f"{self.roman2_numbers[self.counter2 - 1]}. {text}{self.selected_punctuation}"  # Append selected punctuation
            self.counter2 += 1  # Increment counter2
    ...
    def insert_predefined_text2(self, text1=None):
        if text1 is None:
            text1 = self.predefined_texts["Yearly exam"]  # Default to the first predefined text
        
        # Apply bold formatting to the predefined text
        self.text_box.insert(tk.END, text1 + "\n", "predefined")  
        self.text_box.tag_configure("predefined", font=("Arial", 14, "bold"))

    def insert_predefined_text3(self, text2=None):
        self.counter = 1  # Reset the counter to 1
        if text2 is None:
            text2 = self.predefined_texts["Yearly exam"]  # Default to the first predefined text
