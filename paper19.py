...
class SpeechToTextApp:
    def __init__(self, root):
        ...
        self.predefined_texts = {
            ...
            "Class": "                                                                                     कक्षा – 6 विषय – हिन्दी",
            "The note": "                                                                                   नोट – सभी प्रश्न अनिवार्य है –"
        }
        
        self.my_predefined_texts = {
            "Teena": {
                "The Architect": "Teena - The Architect",
                "The Doctor": "Teena - The Doctor",
                "The Teacher": "Teena - The Teacher"
            },
            "Savita": {
    ...
    def create_widgets(self):
        ...
        teena_submenu = tk.Menu(many_text_submenu, tearoff=0)
        savita_submenu = tk.Menu(many_text_submenu, tearoff=0)
        mohini_submenu = tk.Menu(many_text_submenu, tearoff=0)

        # Populate teena submenu
        teena_submenu.add_command(label="The Architect", command=lambda: self.insert_predefined_text2("Teena - The Architect"))
        teena_submenu.add_command(label="The Doctor", command=lambda: self.insert_predefined_text2("Teena - The Doctor"))
        teena_submenu.add_command(label="The Teacher", command=lambda: self.insert_predefined_text2("Teena - The Teacher"))

        # Populate savita submenu
        savita_submenu.add_command(label="The Architect", command=lambda: self.insert_predefined_text2("Savita - The Architect"))
        savita_submenu.add_command(label="The Doctor", command=lambda: self.insert_predefined_text2("Savita - The Doctor"))
        savita_submenu.add_command(label="The Teacher", command=lambda: self.insert_predefined_text2("Savita - The Teacher"))

        # Populate mohini submenu
        mohini_submenu.add_command(label="The Architect", command=lambda: self.insert_predefined_text2("Mohini - The Architect"))
        mohini_submenu.add_command(label="The Doctor", command=lambda: self.insert_predefined_text2("Mohini - The Doctor"))
        mohini_submenu.add_command(label="The Teacher", command=lambda: self.insert_predefined_text2("Mohini - The Teacher"))

        # Add submenus to "many text" submenu
        many_text_submenu.add_cascade(label="Teena", menu=teena_submenu)
        many_text_submenu.add_cascade(label="Savita", menu=savita_submenu)
        many_text_submenu.add_cascade(label="Mohini", menu=mohini_submenu)

        # Add "many text" submenu to main menu
        menu.add_cascade(label="Many Text", menu=many_text_submenu)
