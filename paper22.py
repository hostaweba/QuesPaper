...
class SpeechToTextApp:
    def __init__(self, root):
        ...
        self.another_predefined_texts = {
            "Short Ques": "This is the text for Example first.",
            "Long Ques": "This is the text for Example second.",
            ...
            if filename:
                ...
                with open(file_path, "r", encoding="utf-8") as file:
                    ...
                    for line in predefined_text:
                        ...
                        numbered_text += f"{self.roman_numbers[self.counter2 - 1]}. {line.strip()}\n\n"
                        self.counter2 += 1
    ...
    def insert_predefined_text3(self, text=None):
        ...
        # Add Roman numbering and default punctuation to each sentence
        formatted_text = ""
